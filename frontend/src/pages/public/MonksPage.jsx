...
export function MonksPage() {
  ...
  const monks = Array.isArray(INITIAL_MONKS) ? INITIAL_MONKS : [];

  const headMonk = monks[0] || null;

  const otherMonks = monks.slice(1);

  // ============================================================
  // NEW IMAGE MAPPING
  // IMPORTANT:
  // Keep ALL monks from data.js.
  // Only replace images for matching monk names.
  // ============================================================
  ...
  const getMonkImage = (monk) => {
    if (!monk) return kruImage;

    // Head Abbot
    if (headMonk && monk.id === headMonk.id) {
      return kruImage;
    }

    // Normalize Khmer name
    const name = String(
      monk.khmerName ||
      monk.name ||
      ""
    ...
    // ==========================================================
    if (
      name.includes("ថាច់ ធា") ||
      name.includes("ថាច់ធា")
    ) {
      return monkImage1;
    }
    ...
    // ==========================================================
    if (
      name.includes("ថាច់ ង៉ុកហូវ") ||
      name.includes("ថាច់ង៉ុកហូវ") ||
      name.includes("ង៉ុកហូវ")
    ) {
      return monkImage2;
    }
    ...
    // ==========================================================
    if (
      name.includes("ថាច់ សាយ៉ាង") ||
      name.includes("ថាច់សាយ៉ាង") ||
      name.includes("សាយ៉ាង")
    ) {
      return monkImage3;
    }
    ...
    // ==========================================================
    if (
      name.includes("ព្រះមហា ចៅ រិទ្ធី") ||
      name.includes("ព្រះមហាចៅ រិទ្ធី") ||
      name.includes("ព្រះមហា ចៅរិទ្ធី") ||
      name.includes("ចៅ រិទ្ធី") ||
      name.includes("ចៅរិទ្ធី") ||
      name.includes("រិទ្ធី")
    ) {
      return monkImage4;
    }
    ...
    // ==========================================================
    // 5. គឹម ហ្វាយញ៉ឹង
    // File: គឹម ហ្វាយញ៉ឹង.png
    // ==========================================================
    if (
      name.includes("គឹម ហ្វាយញ៉ឹង") ||
      name.includes("គឹមហ្វាយញ៉ឹង") ||
      name.includes("ហ្វាយញ៉ឹង")
    ) {
      return monkImage5;
    }

    // ==========================================================
    // EXISTING IMAGE FROM data.js
    // ==========================================================
    return (
      monk.portrait ||
      monk.image ||
    ...
    <div className="py-10 space-y-16">
      ...
      >
        ...
        <p
          ...
          "
        >
          ព្រះសង្ឃជាអ្នកបន្តវេនព្រះធម៌វិន័យ និងដឹកនាំការបដិបត្តិធម៌
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.img
                      src={kruImage}
                      alt={headMonk.khmerName || "ព្រះគ្រូចៅអធិការ"}
                      className="
                        w-full
                        h-full
                        object-cover
              ...
              >
                ...
                {Array.isArray(headMonk.responsibilities) &&
                  headMonk.responsibilities.length > 0 && (
                    ...
                    >
                      ...
                      <div className="space-y-2.5">
                        {headMonk.responsibilities.map((item, index) => (
                          <div
                            key={index}
                            className="
                                flex
                ...
                <div className="pt-2">
                  <Button
                    variant="primary"
                    size="md"
                    onClick={() => setSelectedMonk(headMonk)}
                  >
              ...
              >
                <div>
                  ...
                  <h3
                    ...
                    "
                  >
                    {monk.khmerName || monk.name || "ព្រះសង្ឃ"}
                  </h3>
      ...
      {selectedMonk && (
        <Modal
          ...
          title={`ប្រវត្តិសង្ខេប • ${
            selectedMonk.khmerName || selectedMonk.name || ""
          }`}
          maxWidth="max-w-2xl"
        >
          <div className="space-y-6">
            ...
            >
              ...
              >
                <img
                  src={getMonkImage(selectedMonk)}
                  alt={
                    selectedMonk.khmerName || selectedMonk.name || "ព្រះសង្ឃ"
                  }
                  className="
                    w-full
                    h-full
              ...
              <div className="space-y-1.5 text-center sm:text-left">
                {(selectedMonk.vassa || selectedMonk.yearsOrdained) && (
                  <span
                    className="
                      inline-block
                      text-xs
                ...
                {selectedMonk.name &&
                  selectedMonk.name !== selectedMonk.khmerName && (
                ...
                >
                  {selectedMonk.title ||
                    selectedMonk.khmerRole ||
                    selectedMonk.position ||
                    ""}
                </p>
              ...
              selectedMonk.duties.length > 0 && (
                <div>
                  ...
                  <ul className="space-y-1.5 text-xs text-stone-700">
                    {selectedMonk.duties.map((duty, index) => (
                      <li
                        key={index}
                        className="
                            flex
            ...
            {!selectedMonk?.duties?.length &&
              Array.isArray(selectedMonk.responsibilities) &&
              selectedMonk.responsibilities.length > 0 && (
                <div>
                  <h4
                    className="
                      text-xs
                  ...
                  <ul className="space-y-1.5 text-xs text-stone-700">
                    {selectedMonk.responsibilities.map((duty, index) => (
                      <li
                        key={index}
                        className="
                            flex
